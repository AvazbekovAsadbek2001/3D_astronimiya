...
<body>
 <div id="web">
        ...
        <div id="sticky-header"
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="menu">
                        <a href="index.html" class="logo" style="padding: 20px 0 0;">
                            <h4><img src="png.images/580b585b2edbce24c47b270d.png" width="50px" style="margin-right: 10px; margin-bottom: 10px;"><b>Astranomiya</b></h4>
                        </a>
                        <ul class="clearfix">
                            <li>
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="single_slider wow fadeInUp" data-wow-delay=".4">
                            ...
                            <div class="em-hero-inner-shape rotateme">
                                <img src="png.images/meteor_PNG36.png" width="100px"/>
                            </div>
                        ...
                        <div class="hero_section_thumb wow fadeInDown" data-wow-delay=".5">
                            ...
                            ">
                              ...
                              {{-- <div class="em-hero-inner-thumb rotateme">
                                <img src="png.images/meteor_PNG21.png" width="100px">
                              </div> --}}
                              <div class="em-hero-icon-thumb">
                                <img src="png.images/meteor_PNG21.png" alt="" width="100" style="margin-top: 250px">
                              </div>
                              <div class="em-hero-inner-thumb1 bounce-animate3">
                                <img src="png.images/meteor_PNG29.png" alt="" width="130px">
                              </div>
                              {{-- <div class="em-hero-inner-thumb2 bounce-animate">
                                <img src="  " width="130px">
                              </div> --}}
                              {{-- <div class="em-hero-inner-thumb3 bounce-animate4">
                                <img src="png.images/580b585b2edbce24c47b270d.png" width="100px">
                              </div> --}}
                              {{-- <div class="em-hero-inner-thumb4 bounce-animate5">
                                <img src="png.images/1636367.png" width="100px">
                              </div> --}}
                        </div>
                    </div>
                </div>
        ...
        <!--==================================================-->
          <div class="portfolio_area style-four pt-110 pb-70">
            <div class="container">
                 <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="col-lg-4 col-md-6 grid-item physics english">
                    <div class="single_portfolio wow fadeInLeft" data-wow-delay=".5">
                        <div class="single_portfolio_inner">
                            <div class="single_portfolio_thumb1">
                            <a href="{{ route('subjects') }}"
                                ><img src="png.images/darslar.png" alt=""
                            /></a>
                            </div>
                        </div>
                    <div class="single_portfolio_content1">
                        ...
                        <h2 align="center">
                            <a href="{{ route('subjects') }}">Astronomiya darslari</a>
                        </h2>
                        </div>
                    </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 grid-item cemes">
                    <div class="single_portfolio wow fadeInUp" data-wow-delay=".6">
                    <div class="single_portfolio_inner">
                        <div class="single_portfolio_thumb1">
                        <a href="#"
                            ><img src="png.images/unnamed2.png" alt="" style="object-fit: contain"
                        /></a>
                        </div>
                    </div>
                    <div class="single_portfolio_content1">
            ...
            <div class="container">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="section_title text_left mb-30 mt-3 wow fadeInRight" data-wow-delay=".4">
                            ...
                            <div class="section_content_text upper">
                                <p>
                                    Yusupova Kamola Fozilxonovna fizika fani òqituvchisi.
                                </p>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <div class="section_title text_left mb-30 mt-3 wow fadeInRight" data-wow-delay=".4">
                            <div class="section_main_title upper">
                                <h1>Ilmiy rahbar <span>ma'lumotlari</span></h1>
                            </div>
                            <div class="section_content_text upper">
                                <p>
